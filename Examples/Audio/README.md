...
| [FilePlayer](FilePlayer/Sketch.swift) | reacts to a playing audio file — a spectrum bar chart plus a waveform oscilloscope; loops a bundled clip (*El Fandanguito*, a traditional Mexican son huasteco for violin, CC BY-SA) by default, or pass a path on launch to play your own track (`AudioPlayer`, `spectrum`, `waveform`) |
