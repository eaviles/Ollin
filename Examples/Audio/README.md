...
| [Wavetable](Wavetable/Sketch.swift) | a wave you can draw: a row of cycles a note reads by position and moves through as it sounds, with the frames stacked and the cycle the next note reads drawn over them (`Wavetable`, `WavetableScan`) |
