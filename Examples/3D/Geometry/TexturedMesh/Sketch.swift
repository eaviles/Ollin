...
/// the dark lines are the UV gridlines — you can read the poles pinching and the seam
...
final class TexturedMeshExample: Sketch {
    ...
    private lazy var floor = Mesh.plane(width: 6, depth: 6).textured(grid, baseColor: Color(white: 0.7))
    ...
    override func draw() {
        ...
        drawCaption("TexturedMesh — a UV-mapped image on a sphere; drag to spin")
    }
