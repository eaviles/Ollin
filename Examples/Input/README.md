...
| [Pen](Pen/Sketch.swift) | a broad-edged nib that reads a tablet: the chisel lies across the way the pen leans, the press sets how wide, the eraser end takes ink away, and a panel says what the stylus is sending (`pen`, `pressure`) |
