...
let package = Package(
    ...
    targets: [
        ...
        example("Effects/Fourier", [.samplePhotos]),
        ...
        example("3D/Materials/Parallax", [.samplePhotos]),
        example("3D/Materials/SurfaceMaps"),
        example("3D/Materials/Triplanar", [.samplePhotos]),
        ...
        example("3D/Materials/LiveSurface", [.vision]),
        ...
        example("3D/Phone/PhoneMarkers", [.phone, .samplePhotos]),
        ...
        example("Color/PaletteFromImage", [.samplePhotos]),
        ...
        example("Patterns/ParquetDeformation"),
        ...
        example("Images/GlyphMosaic", [.samplePhotos]),
        example("Images/PhotoMosaic", [.samplePhotos]),
        example("Images/Autostereogram"),
        example("Images/Fit", [.samplePhotos]),
        example("Images/Halftone", [.samplePhotos]),
        example("Images/LuminanceMelt", [.samplePhotos]),
        example("Images/PixelField"),
        example("Images/PixelSort", [.samplePhotos]),
        ...
        // One form-idea cut from the circle, the triangle and the square, taken
        // from the painting to the relief to the standing piece and back; and
        // a design the machine accepted, raised into a lacquered relief under a
        // raking light, after Manuel Felguérez.
        example("Recreations/ManuelFelguerez/EspacioMultiple"),
        example("Recreations/ManuelFelguerez/RelieveLacado"),
