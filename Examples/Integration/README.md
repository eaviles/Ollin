...
Sketches that talk to the other apps and gear in a rig: control in over OSC and MIDI, visuals out (and in) over Syphon. Each protocol lives in its own library — `import OllinOSC`, `import OllinMIDI`, `import OllinSyphon` — see the [OSC](../../Docs/OSC.md), [MIDI](../../Docs/MIDI.md), and [Syphon](../../Docs/Syphon.md) references.
