...
/// sounds. `Synth.pressure` is that driving.
public enum VoiceSource: Sendable, Hashable, Codable {
    ...
    ///
    /// The two driven kinds read `Synth.pressure`; the rest ignore it entirely.
