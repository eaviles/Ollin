...
extension Capability {
    ...
    public static let images = Capability(
        ...
        assetFolders: [.init(
            name: "Images",
            note: "Pictures the sketch loads. Reach one with `try Image(resource: \"name\", withExtension: \"png\", in: .module)`."
        )],
        starterHint: "let picture = try! Image(resource: \"photo\", withExtension: \"jpg\", in: .module)"
    )
