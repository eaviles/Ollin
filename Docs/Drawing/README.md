...
- [`Strange attractors`](./Attractors.md) - chaotic systems as points: continuous 3D orbits (Lorenz, Rössler, Aizawa, …) integrated with Runge-Kutta and orbited through the camera, and 2D iterated maps (Clifford, de Jong, Hénon) accumulated into density fields
