...
- [`Evolution`](./Evolution.md) - populations that get better at something: `Evolution` breeds tens of thousands of GPU flights toward a target past obstacles by tournament selection, and `Population` breeds a handful of genomes a person picks by eye
