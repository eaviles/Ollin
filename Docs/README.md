...
- [`Geometry`](./Drawing/Geometry.md) - the `Vector2`, `Ray3`, `Rectangle`, `Grid`, `Shape`/`Contour`, and `Path` value types (including the `Grid` layout helper, curved outlines, shape booleans, and offsetting)
