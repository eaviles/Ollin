...
- [`Combining 3D features`](./3D/Combining.md) - the practical map of what stacks with what: which geometry takes lights, materials, matcaps, and environment light; who casts, receives, and appears in shadows and reflections; and when to reach for screen-space versus ray-traced reflections
