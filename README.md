...
| Area | What's in it |
| --- | --- |
| [**Shapes & geometry**](Docs/Drawing/Drawing.md) | Some thirty analytic shapes from circles to stars to hearts, curved paths, concave and holed fills, variable-width strokes that taper and turn like a nib, [booleans and offsets](Docs/Drawing/Geometry.md), [gradient paint](Docs/Drawing/Geometry.md) on everything, blend modes, clipping, [SVG import](Docs/Drawing/SVG.md), `noClear()` [accumulation](Docs/Drawing/Accumulation.md) for long-exposure looks, and [retained batches](Docs/Drawing/Batches.md) when static content gets heavy |
