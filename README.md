...
| [**Layered effects**](Docs/Drawing/Effects.md) | Off-screen layers with fifty-plus GPU filters, two-layer combines (mask, displace, depth of field, ambient occlusion, screen-space reflections), diffusion curves, feedback layers, and GPU simulation fields, all declarable as one `compose { }` block |
