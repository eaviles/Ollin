...
| **Plays in your rig** | [Syphon](Docs/Integration/Syphon.md) out and in, a system-wide [virtual camera](Docs/Integration/VirtualCamera.md) any webcam app can read, [screen and window capture](Docs/Integration/ScreenCapture.md) that takes any app on the Mac as live material whether or not it cooperates, [video playback](Docs/Video/Video.md) as live GPU textures, and [slit-scan time displacement](Docs/Video/SlitScan.md) over any frame history |
