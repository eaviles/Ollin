...
| [**Text & color**](Docs/Drawing/Text.md) | Bitmap, outline, and single-line plotter fonts through one `drawText`, text as vector `Shape`s, [OKLab mixing](Docs/Drawing/Color.md), palette import and extraction, colormaps, gradients, and [images](Docs/Drawing/Images.md) with pixel access, dithering, [pixel sorting](Docs/Drawing/PixelSorting.md), and [glyph mosaics](Docs/Drawing/GlyphMosaic.md) |
