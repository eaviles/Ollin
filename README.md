...
| [Blurry](https://github.com/Domenicobrz/Blurry) | MIT | Scaling the sandpainting depth-of-field rendering to millions of samples generated GPU-side: progressive refinement and compute-driven sample counts, beyond the CPU-driven prototype already in the examples. |
