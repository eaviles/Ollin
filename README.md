...
- The signed-distance fields behind circles, ellipses, rectangles, lines, circular arcs, triangles, regular polygons and stars, rhombuses, vesicas, moons, crosses, rings, and point markers (box, capsule, pie, arc, isosceles triangle, star, rhombus, vesica, moon, cross, and the onion operator for rings) come from [Inigo Quilez's 2D distance functions](https://iquilezles.org/articles/distfunctions2d/).
