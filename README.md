...
| [**Simulation & physics**](Docs/Simulation/Physics.md) | A stepped `World` with Verlet particles and springs on the soft side, Box2D bodies and joints on the rigid side, plus [SPH fluids and soft bodies](Docs/Simulation/Fluids.md), reaction-diffusion, Lenia, Game of Life, water-surface ripples, multi-scale Turing patterns, and real-time fluid on the GPU, and [articulated and chaotic motion](Docs/Simulation/Motion.md) for IK chains, pendulums, and n-body gravity |
