...
| [**Perception**](Docs/Vision/Vision.md) | Sixteen on-device trackers over the Mac's camera or any [video](Docs/Video/Video.md): face, hand, and body pose in 2D and 3D, segmentation, contours, optical flow, OCR, saliency, and custom Core ML models. An [iPhone](Docs/3D/Phone.md) extends that with LiDAR depth clouds, the reconstructed room as a labelled surface, ARKit body and face capture, and device motion over USB, live or from [recorded clips](Docs/3D/Record3D.md), all as metric [RGBD frames](Docs/3D/RGBD.md) |
