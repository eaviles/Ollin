...
Ollin bundles [fourteen photographs](../Docs/Drawing/SamplePhotos.md) for exactly this. Four faces, four whole figures, two tables from above, four streets, two landscapes, a page, a pair of hands and two surfaces, so a sketch that reads people has people to read. The vision examples all do it this way, which is why they run on a machine with nothing plugged in. `--photo` on launch takes the picture even where a camera would have worked, which is how you get a still of a sketch that is normally live.
...
<img src="Images/30-Seeing/Trajectory.jpg" alt="Two panels: six frames of a made-up clip overlaid, showing a bright ball rising in six steps, and the same clip's newest frame with orange dots on the sightings, a fitted arc, and a dashed continuation passing through pale rings" width="680">
...
[Contents](README.md#contents) · Previous: [Chapter 29, Making sound](29-MakingSound.md) · Next: [Chapter 31, Sharing and performing](31-SharingAndPerforming.md)
