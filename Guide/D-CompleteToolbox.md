...
| `@Param` knobs | Properties as live inspector controls, typed per value (slider, color well, pad, …) | [Ch 1](01-HelloOllin.md), [Ch 23](23-SoundAndControl.md) | [Parameters](../Docs/Helpers/Parameters.md) |
...
| Bringing a scene over | `ollin new --from-scene`: a glTF or USD scene written out as the camera, light and placement calls that draw it | [Ch 20](20-3DGently.md) | [SceneImport](../Docs/Tools/SceneImport.md) |
...
| Accumulation | `noClear()`: a persistent canvas that piles up across frames | [Ch 16](16-LayersAndEffects.md), [Ch 19](19-Simulations.md) | [Accumulation](../Docs/Drawing/Accumulation.md) |
...
| Capability | What it is | Guide | Reference |
|---|---|---|---|
| Vectors | `Vector2`/`Vector3` with real operators, length, normalize, lerp, rotate | [Ch 10](10-Vectors.md), [Ch 20](20-3DGently.md) | [Geometry](../Docs/Drawing/Geometry.md) |
...
| Isosurfaces and metaballs | The surface where a field over space crosses a level, marched into a `Mesh` (marching cubes): soft spheres that fuse, noise volumes, gyroids | [Ch 21](21-SculptingWithFields.md) | [Isosurfaces](../Docs/Generators/Isosurface.md) |
| Subdivision surfaces | `mesh.subdivided`: a low-poly control cage refined into a smooth solid (Catmull-Clark or Loop), welding and open edges handled for you | [Ch 20](20-3DGently.md) | [Subdivision surfaces](../Docs/Generators/SubdivisionSurfaces.md) |
| Mesh growth | `MeshGrowth`: a surface that grows more area than it has room for and folds, driven evenly, by curvature, by your own field, or by a reaction-diffusion pattern in the surface | [Ch 20](20-3DGently.md) | [Mesh growth](../Docs/Generators/MeshGrowth.md) |
| Surface reconstruction | `reconstructSurface` / `particleSurface`: a scanned or generated point cloud back to a `Mesh`, data holes kept honest; particle sets skinned as one blended body | [Ch 22](22-DepthAndThePhone.md) | [Surface reconstruction](../Docs/Generators/SurfaceReconstruction.md) |
...
| Strange attractors | Lorenz, Clifford, de Jong, and friends, as orbits you draw | [Ch 18](18-IteratedForms.md) | [Attractors](../Docs/Drawing/Attractors.md) |
...
| Cellular automata | `elementaryCA` / `totalisticCA` rules and `Turmite` ants: tiny rules, long runs | [Ch 19](19-Simulations.md) | [Cellular automata](../Docs/Generators/CellularAutomata.md) |
| Lenia | `.lenia`: the continuous Game of Life, smooth mass that grows colonies and creatures | [Ch 19](19-Simulations.md) | [Effects](../Docs/Drawing/Effects.md#simfield) |
...
| 3D physics | `World3D`: rigid bodies that stack, tumble, and swing inside the 3D scene, with joints and camera grabbing | [Ch 20](20-3DGently.md) | [Physics3D](../Docs/Simulation/Physics3D.md) |
...
| Artificial life | `ParticleLife`, `PPS`, `Physarum`, `ParticleLenia`, `SwarmChemistry` on the public `SpatialHash` neighbor search | [Ch 19](19-Simulations.md) | [Artificial life](../Docs/Simulation/ArtificialLife.md) |
| Ant colony | A pheromone-trail colony condensing a web of possibilities onto a short tour | [Ch 19](19-Simulations.md) | [AntColony](../Docs/Generators/AntColony.md) |
| Steering at scale | `Swarm`: separation, alignment, cohesion, seek, flee, arrive, wander, and flow as weights over tens of thousands of agents | [Ch 19](19-Simulations.md) | [Swarm](../Docs/Simulation/Swarm.md) |
| Evolution | `Evolution`: GPU populations bred toward a target past obstacles by tournament selection; `Population` + `Genome`: a handful of genomes bred from the ones you pick by eye | [Ch 19](19-Simulations.md) | [Evolution](../Docs/Simulation/Evolution.md) |
| Particle fluids | `ParticleFluid`: SPH liquid with a free surface, splashes, and grabbing | [Ch 19](19-Simulations.md) | [Fluids](../Docs/Simulation/Fluids.md) |
| Soft bodies | `SoftBodies`: shape-matched jellies that squash and pile | [Ch 19](19-Simulations.md) | [Fluids](../Docs/Simulation/Fluids.md) |
...
| Combines | Two-layer ops: mask, displace, mix, depth-of-field, SSAO, reflections | [Ch 16](16-LayersAndEffects.md), [Ch 20](20-3DGently.md) | [Effects](../Docs/Drawing/Effects.md) |
...
| Simulation fields | Game of Life, Gray-Scott reaction-diffusion, Lenia, the ripple pool, and real-time fluid, all seeded by drawing into them | [Ch 19](19-Simulations.md) | [Effects](../Docs/Drawing/Effects.md) |
| Ripple pool | `.ripples`: the wave equation as an interactive water surface; drawn marks add height, rings spread and reflect | [Ch 19](19-Simulations.md) | [Effects](../Docs/Drawing/Effects.md#simfield) |
| Watercolor wash | `watercolor(pigments:)`: wet paint on rough paper, with real pigment behavior, darkened edges, backruns, dry-brush, and optical glazing | [Ch 19](19-Simulations.md) | [Watercolor](../Docs/Simulation/Watercolor.md) |
...
| Compute kernels | Your own GPU code over buffers and textures, hot-reloadable | [Ch 19](19-Simulations.md) | [Compute](../Docs/Shaders/Compute.md) |
| GPU particles | A million particles updated and drawn without touching the CPU | [Ch 19](19-Simulations.md) | [Compute](../Docs/Shaders/Compute.md) |
| GPU simulations | Ping-pong texture simulations drawn as images | [Ch 19](19-Simulations.md) | [Compute](../Docs/Shaders/Compute.md) |

## 3D

| Capability | What it is | Guide | Reference |
|---|---|---|---|
| The camera | `camera()`, `perspective`, `ortho`; 2D sketches never pay for it | [Ch 20](20-3DGently.md) | [3D](../Docs/3D/3D.md) |
| Solid primitives | Box, sphere, torus, knots, Platonic solids, lathes, extrusions, and more | [Ch 20](20-3DGently.md) | [3D](../Docs/3D/3D.md) |
| Terrain | `Heightfield`: landscapes grown from noise or diamond-square, weathered by simulated rain and gravity, read out as a mesh, an image, or samples | [Ch 20](20-3DGently.md) | [Terrain](../Docs/Generators/Terrain.md) |
| Meshes from file | OBJ, glTF, USDZ, STL, PLY, with materials and textures; `normalized(scale:)` recenters and fits whatever arrives | [Ch 20](20-3DGently.md) | [3D](../Docs/3D/3D.md) |
| Scenes from file | `loadScene` keeps a glTF's structure: named nodes drawn in place with `drawScene`, the authored camera and lights as ready values, one node reached by name to animate | [Ch 20](20-3DGently.md) | [Scenes](../Docs/3D/Scenes.md) |
| Lights | Directional, point, spot, ambient, glowing panels, disks, and tubes, plus curated lighting presets | [Ch 20](20-3DGently.md) | [3D](../Docs/3D/3D.md) |
| Light shaping | A real fixture's measured throw on a light (IES files), and an image projected through a spot (a cookie, the stage gobo) | [Ch 20](20-3DGently.md) | [3D](../Docs/3D/3D.md#light-shaping-ies-profiles-and-cookies) |
| Atmosphere | Fog that fades surfaces with distance and pools low with a height falloff, aerial perspective that veils far geometry blue toward the sky's own sun, and volumetric light that turns spot cones, cookies, and cast shadows into visible beams and shafts | [Ch 20](20-3DGently.md) | [Atmosphere](../Docs/3D/Atmosphere.md) |
| Caustics | The light glass and polished metal focus, photon-traced: a lens's bright spot inside its own shadow, a chrome ring's folded fan, prism rainbows via dispersion | [Ch 21](21-SculptingWithFields.md) | [Caustics](../Docs/3D/Caustics.md) |
| Materials | Stylized finishes (toon, iridescent, velvet, sparkle), and physically based metal and gloss from just metalness and roughness | [Ch 20](20-3DGently.md), [Ch 21](21-SculptingWithFields.md) | [3D](../Docs/3D/3D.md) |
| Matcaps | Shading read from a picture of a lit sphere: chrome, clay, car paint, in one call and no lights | [Ch 20](20-3DGently.md) | [3D](../Docs/3D/3D.md#matcap-materials) |
| Environments | HDRI image-based lighting (eight bundled, twelve downloading) plus a zero-asset procedural sky; the surroundings become the light | [Ch 21](21-SculptingWithFields.md) | [3D](../Docs/3D/3D.md#environment-lighting) |
| Shadows | Contact-hardening cast shadows with a softness dial, ray-traced for point lights on capable GPUs | [Ch 20](20-3DGently.md) | [3D](../Docs/3D/3D.md#shadows) |
| Ray-traced reflections | Metals that reflect the actual scene, off-screen parts included | [Ch 21](21-SculptingWithFields.md) | [3D](../Docs/3D/3D.md) |
| Wireframe and textures | Any mesh as its triangle edges (which do not light); any mesh wrapped in an image through its UVs, or with no UVs at all through a triplanar projection | [Ch 20](20-3DGently.md) | [3D](../Docs/3D/3D.md#textures) |
| Point clouds | Instanced splats by the hundred thousand, camera-facing | [Ch 22](22-DepthAndThePhone.md) | [3D](../Docs/3D/3D.md) |
| Camera control and moves | Viewer orbiting, cinematic `CameraMove`s, the self-driving showcase, snap views | [Ch 20](20-3DGently.md) | [Camera](../Docs/3D/Camera.md) |
| Scene chrome | The axis widget and ground grid, live-only, never exported | [Ch 20](20-3DGently.md) | [Camera](../Docs/3D/Camera.md) |
| Instanced meshes | One mesh drawn thousands of times in one call: `MeshInstance` placements the GPU applies per copy, or a compute-written buffer | [Ch 20](20-3DGently.md) | [Instancing](../Docs/3D/Instancing.md) |
| Mesh fields | A retained world of placed meshes drawn by one call, GPU-culled per copy against the camera (`MeshField`/`drawMeshField`) | [Ch 20](20-3DGently.md) | [Instancing](../Docs/3D/Instancing.md) |
| Strand fields | Grass grown inside the draw call: bending, swaying blades with no geometry buffers, camera-culled and distance-graded (`StrandField`/`drawStrands`) | [Ch 20](20-3DGently.md) | [Strands](../Docs/3D/Strands.md) |
| Depth compositing | Flat 2D drawing placed *inside* the 3D depth buffer, so the scene occludes it: `depth(at:)`, `project`, billboards, depth feeds | [Ch 22](22-DepthAndThePhone.md) | [DepthCompositing](../Docs/3D/DepthCompositing.md) |
| What stacks with what | The compatibility map across the 3D features | [Ch 20](20-3DGently.md), [Ch 21](21-SculptingWithFields.md) | [Combining](../Docs/3D/Combining.md) |

## Sculpting with fields

| Capability | What it is | Guide | Reference |
|---|---|---|---|
| 2D SDF combinators | Shapes as distance fields that merge, melt, morph, and repeat | [Ch 21](21-SculptingWithFields.md) | [Combinators](../Docs/Drawing/Combinators.md) |
| The `sculpt { }` block | Add, carve, and blend region shapes with stateful verbs, built for live coding | [Ch 21](21-SculptingWithFields.md) | [Combinators](../Docs/Drawing/Combinators.md) |
| Raymarched 3D fields | `SDF3D` sphere-traced through the camera, depth-composited with meshes | [Ch 21](21-SculptingWithFields.md) | [Combinators](../Docs/Drawing/Combinators.md) |

## Depth and the phone

| Capability | What it is | Guide | Reference |
|---|---|---|---|
| RGBD frames | Color plus depth plus intrinsics; unproject any pixel to a metric point | [Ch 22](22-DepthAndThePhone.md) | [RGBD](../Docs/3D/RGBD.md) |
| Recorded captures | Open `.r3d` depth recordings as point clouds with true intrinsics | [Ch 22](22-DepthAndThePhone.md) | [Record3D](../Docs/3D/Record3D.md) |
| Live USB depth | A tethered phone's RGBD stream, frame by frame | [Ch 22](22-DepthAndThePhone.md) | [Record3D](../Docs/3D/Record3D.md) |
| The capture app | Ollin's own iPhone app streams body, face, LiDAR depth, segmentation, and motion | [Ch 22](22-DepthAndThePhone.md) | [Phone](../Docs/3D/Phone.md) |
| World fusion | Sweep the phone; frames fuse into one fixed world cloud by pose | [Ch 22](22-DepthAndThePhone.md) | [Phone](../Docs/3D/Phone.md) |

## Sound and control

| Capability | What it is | Guide | Reference |
|---|---|---|---|
| Audio analysis | Amplitude, spectrum, waveform, log-spaced bands ready to draw | [Ch 23](23-SoundAndControl.md) | [Audio](../Docs/Helpers/Audio.md) |
| Beat detection | Onsets as events: `beat`, `beatCount`, `timeSinceBeat` | [Ch 23](23-SoundAndControl.md) | [Audio](../Docs/Helpers/Audio.md) |
| Audio sources | Microphone, audio files (export-reproducible), test tones, a video's soundtrack | [Ch 23](23-SoundAndControl.md), [Ch 24](24-Seeing.md) | [Audio](../Docs/Helpers/Audio.md) |
| Listening | Speech as a caption that corrects itself and phrases you can trigger from, plus 300-odd everyday sounds named as they happen | [Ch 23](23-SoundAndControl.md) | [Listening](../Docs/Helpers/Listening.md) |
| Synthesis | A `Synth` the sketch plays: notes by name or number, voice presets, envelopes, filters, delay and reverb, two physical models (a plucked string and a struck shape), sound placed in the 3D scene, and a soundtrack in an export | [Ch 23](23-SoundAndControl.md) | [Synthesis](../Docs/Helpers/Synthesis.md) |
| Composition | Working out what to play: Euclidean rhythms, scales and chords, arpeggios, Markov sequences, all on a step number | [Ch 23](23-SoundAndControl.md) | [Composition](../Docs/Helpers/Composition.md) |
| Sonification | Numbers read out as notes: a table column, a terrain profile, or a picture row spread over a range of pitch and snapped to a scale | [Ch 23](23-SoundAndControl.md) | [Sonification](../Docs/Helpers/Sonification.md) |
| MIDI | Knobs, notes, and messages from hardware controllers, in and out | [Ch 23](23-SoundAndControl.md) | [MIDI](../Docs/Integration/MIDI.md) |
| OSC | Network control messages from tablets, DAWs, and other machines | [Ch 23](23-SoundAndControl.md) | [OSC](../Docs/Integration/OSC.md) |
| Game controllers | Sticks, triggers, and buttons read in `draw()`, plus motion and a touchpad on hardware that has them, with several players at once and a null read when nothing is plugged in | [Ch 23](23-SoundAndControl.md) | [Controller](../Docs/Integration/Controller.md) |
| Parameter binding | One `@Param` driven by MIDI, OSC, and the inspector alike, with smoothing | [Ch 23](23-SoundAndControl.md) | [Parameters](../Docs/Helpers/Parameters.md) |

## Seeing and video

| Capability | What it is | Guide | Reference |
|---|---|---|---|
| Camera feeds | The webcam (or any frame source) drawn and analyzed live | [Ch 24](24-Seeing.md) | [Vision](../Docs/Vision/Vision.md) |
| People trackers | Faces with landmarks, hands, 2D and 3D body poses, person segmentation | [Ch 24](24-Seeing.md) | [Vision](../Docs/Vision/Vision.md) |
| Scene trackers | Contours, rectangles, barcodes, text (OCR), saliency, classification, subject lift, point-prompted lift | [Ch 24](24-Seeing.md) | [Vision](../Docs/Vision/Vision.md) |
| Motion trackers | Object tracking, thrown-object trajectories, dense optical flow | [Ch 24](24-Seeing.md) | [Vision](../Docs/Vision/Vision.md) |
| `ModelTracker` | Bring any Core ML model: classifiers, detectors, image-to-image maps, segmenters | [Ch 24](24-Seeing.md) | [Vision](../Docs/Vision/Vision.md) |
| Still analysis | Every tracker also runs one-shot on an `Image` | [Ch 24](24-Seeing.md) | [Vision](../Docs/Vision/Vision.md) |
| Video playback | Files as live textures: play, seek, loop, analyze, all export-reproducible | [Ch 24](24-Seeing.md) | [Video](../Docs/Video/Video.md) |
| Slit scan | A rolling frame history read back through a per-pixel time delay: time as a spatial dimension | [Ch 24](24-Seeing.md) | [SlitScan](../Docs/Video/SlitScan.md) |

## Sharing and performing

| Capability | What it is | Guide | Reference |
|---|---|---|---|
| Stills and sequences | `--export` a frame, `--export-sequence` a folder of them | [Ch 25](25-SharingAndPerforming.md) | [Export](../Docs/Output/Export.md) |
| Path-traced export | `--path-traced` renders the 3D scene by tracing light: soft shadows, bounce color, mirror in mirror, real glass, glowing meshes as lights, textures in the bounces, a real lens | [Ch 25](25-SharingAndPerforming.md) | [Path-traced export](../Docs/Output/PathTraced.md) |
| Video and GIF | `--export-video` (H.264, HEVC, ProRes) and `--export-gif`, deterministic | [Ch 3](03-MotionAndTime.md), [Ch 25](25-SharingAndPerforming.md) | [Export](../Docs/Output/Export.md) |
| Live recording | `startRecording()` or ⌘⇧R keeps a run as it happens, sound included, through evaluations | [Ch 25](25-SharingAndPerforming.md) | [Recording](../Docs/Output/Recording.md) |
| Record & replay | `--record-take` writes a run's seed, clock, inputs, and knobs down; `--replay` plays it back exactly, scrubs it, and re-renders it through any export | [Ch 25](25-SharingAndPerforming.md) | [Replay](../Docs/Core/Replay.md) |
...
| SVG for plotters | `--export-svg` true vectors, with `--hatch` turning fills into line work | [Ch 15](15-ShapesAsMaterial.md), [Ch 25](25-SharingAndPerforming.md) | [Export](../Docs/Output/Export.md) |
| Print separations | `--export-separations`: one grayscale master per spot ink, screened, with an overprint preview | [Ch 25](25-SharingAndPerforming.md) | [PrintSeparations](../Docs/Output/PrintSeparations.md) |
| 3D printing | `mesh.write(to:)` as STL, OBJ, or 3MF at a real size, with `printCheck()` reporting whether the surface is a solid | [Ch 25](25-SharingAndPerforming.md) | [Fabrication](../Docs/Output/Fabrication.md) |
| Spatial models | `--export-usdz` writes a 3D frame (or any `Scene`) as USDZ: opens in Quick Look, sends in a message, stands on a table in AR | [Ch 25](25-SharingAndPerforming.md) | [Spatial](../Docs/Output/Spatial.md) |
| Spatial video | `--export-spatial` writes the motion as a stereo pair per frame (MV-HEVC), with `stereoGeometry` naming how far apart the eyes stand and how far away they agree | [Ch 25](25-SharingAndPerforming.md) | [Spatial](../Docs/Output/Spatial.md#spatial-video) |
| Headless capture | `OllinApp.image(of:frame:)` renders any sketch to a `CGImage` in code, no window; the export flags are wrappers around it, and this guide's figures are made with it | [Ch 25](25-SharingAndPerforming.md) | [Export](../Docs/Output/Export.md) |
| Reproducibility metadata | Every PNG/SVG/PDF/video embeds its recipe: seed, `@Param` values, git commit, frame | [Ch 25](25-SharingAndPerforming.md) | [Export](../Docs/Output/Export.md#reproducibility-metadata) |
...
| Syphon | Publish frames to (and read frames from) other Mac apps, GPU to GPU | [Ch 25](25-SharingAndPerforming.md) | [Syphon](../Docs/Integration/Syphon.md) |
| Virtual camera | Your sketch as a system-wide webcam every video app can pick, including the browser, which Syphon cannot reach | [Ch 25](25-SharingAndPerforming.md) | [VirtualCamera](../Docs/Integration/VirtualCamera.md) |
| DMX lighting | Real lights driven from `draw()` over Art-Net or sACN: a 512-channel universe filled through named fixtures and sent every frame, and a lighting console driving the sketch back | [Ch 25](25-SharingAndPerforming.md) | [DMX](../Docs/Integration/DMX.md) |
| Screen capture | Any display, app, or window on the Mac as a live frame source, whether or not it cooperates the way Syphon needs; a tracker reads it like a camera, and leaving your own window in gives you the feedback tunnel | [Ch 24](24-Seeing.md) | [ScreenCapture](../Docs/Integration/ScreenCapture.md) |
| Live coding | `swift run OllinLiveCoding`: code over visuals, evaluate mid-motion, perform | [Ch 25](25-SharingAndPerforming.md) | [LiveCoding](../Docs/Tools/LiveCoding.md) |
| Extensions | `Sketch.extend`: hooks before, during, and after each frame, for recorders and chrome | [Ch 25](25-SharingAndPerforming.md) | [Sketch](../Docs/Core/Sketch.md#extensions) |
| Running unattended | `installation` puts a piece on a wall: full screen, no pointer, the display kept awake, and a clock that survives a gap in the frames and a week of running | [Ch 25](25-SharingAndPerforming.md) | [Installation](../Docs/Output/Installation.md) |
| Resuming after a stop | `@Saved` properties and a checkpoint cadence write the run down, so a relaunch picks the piece up where it was rather than starting it over | [Ch 25](25-SharingAndPerforming.md) | [Installation](../Docs/Output/Installation.md) |
| Profiling | The inspector's cost row: CPU against GPU on one frame's scale, the draw, pass and batch counts, and a frame handed to Xcode | [Ch 25](25-SharingAndPerforming.md) | [Profiling](../Docs/Tools/Profiling.md) |
| Writing an extension | `ollin new --kind extension`: a library other sketches import, the `ollinx-` naming convention, and the four seams to build on | [Ch 25](25-SharingAndPerforming.md) | [Extensions](../Docs/Tools/Extensions.md) |
