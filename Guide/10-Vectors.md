...
- [Complex numbers](../Docs/Helpers/Complex.md): a `Vector2` that knows how to multiply. Adding is the same as here; multiplying turns, which is what [Chapter 17](17-YourFirstShader.md#multiplying-turns-the-complex-plane) paints and [Chapter 18](18-IteratedForms.md) iterates.
