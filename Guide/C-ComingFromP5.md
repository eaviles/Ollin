...
| p5.sound: `getLevel()`, `p5.FFT` | `AudioAnalyzer`: `amplitude`, `spectrum`, `bands`, beats | [Chapter 27](27-SoundAndControl.md) |
...
| (no built-in SVG) | `--export-svg out.svg` | true vectors, plotter-ready ([Chapter 29](29-SharingAndPerforming.md)) |
...
**Files, not browser tabs.** The working loop is `swift run OllinLive Pulse.swift`, so you save the file and the running window swaps in the change. What you give up is the browser. Sharing a sketch means exporting an artifact, such as a still, a video, a GIF, or an SVG, rather than sending a URL. [Chapter 29](29-SharingAndPerforming.md) is about doing that well.
