...
| Atmosphere: `fog` + `volumetricLight` (`3D/Atmosphere.md`) | Ch 17 | taught ("Air you can see" with a gobo-beam still: fog as the cheapest depth cue, height falloff as pooled mist, the beam march making cones/cookies/profiles/shadow shafts visible in flight, anisotropy as the forward flare, beams-only versus beams-in-fog, and the quality dial's export lift) |
