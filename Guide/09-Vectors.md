...
<img src="Images/09-Vectors/Swarm.jpg" alt="A school of hundreds of small colored streaks on a dark canvas, wheeling together in mid-turn as they chase a small white dot, warm orange leaders ahead of cool blue stragglers" width="560">
...
<img src="Images/09-Vectors/VectorArithmetic.jpg" alt="Four labeled panels: adding two arrows head to tail, the arrow from a pos point to a target point, an arrow scaled longer and flipped, and a long arrow with its unit-length version ending on a circle of radius one" width="680">
...
<img src="Images/09-Vectors/ArrowWalk.jpg" alt="A cream canvas with a dark home dot at lower left, an orange line running to a small wandering target, gray stones spaced along and beyond that line, and a dark line continuing from the target to an orange dot up and to the right" width="560">
...
<img src="Images/09-Vectors/MotionTrio.jpg" alt="A dotted flight arc of a thrown body with three arrows at one moment: a dashed position arrow from the origin, an orange velocity arrow along the path, and a black acceleration arrow pointing straight down" width="680">
...
Every line is arithmetic you already have: a subtraction pointing from here to there, a normalize choosing a speed, a limit keeping it honest. [Chapter 11](11-FlocksAndSwarms.md) builds whole flocks from exactly this correction, aimed at neighbors instead of a target.
...
- A look ahead: [`Examples/Patterns/Flocking`](../Examples/Patterns/Flocking/Sketch.swift) runs this chapter's correction three ways at once, and [Chapter 11](11-FlocksAndSwarms.md) takes it apart.

---

[Contents](README.md#contents) · Previous: [Chapter 8, Words and pictures](08-WordsAndPictures.md) · Next: [Chapter 10, Forces and physics](10-ForcesAndPhysics.md)
