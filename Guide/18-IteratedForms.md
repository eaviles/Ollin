...
- [Attractors](../Docs/Drawing/Attractors.md): every `ChaoticMap`, the `IteratedMap` family, `bifurcationImage`, and the GPU tier that carries a million orbits at once, which [Chapter 20](20-3DGently.md) puts to work as a field of drifting points.
...
[Contents](README.md#contents) · Previous: [Chapter 17, Your first shader](17-YourFirstShader.md) · Next: [Chapter 19, Simulations](19-Simulations.md)
