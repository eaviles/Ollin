...
- **Evolution.** **Genetic / evolutionary** form-finding on the GPU compute path the particle and `SimField` systems already use: selection toward a target or by interaction.
