...
- **Classic distributions and walks.** Low-discrepancy sampling (Halton, Sobol) and weighted-Voronoi stippling for even, organic point sets, and the random-walk family (Lévy flights, self-avoiding walks).
