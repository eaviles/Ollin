...
- **Deeper live-coding evaluation.** Per-block evaluation for the OllinLiveCoding performance host: evaluate just the edited region on its own keystroke. This refines its evaluate-on-command loop.
