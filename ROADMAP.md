...
- **Image quality and motion.** **MetalFX** temporal upscaling for quality and headroom, **contact shadows** (short-range screen-space) to seat objects on surfaces, and per-object and camera **motion blur** over the mover-velocity buffer for cinematic movement.
